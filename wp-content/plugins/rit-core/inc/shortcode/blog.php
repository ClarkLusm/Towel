    ...
    function rit_blog_integrate_vc()
    {
        vc_map(array(
            ...
            "params" => array(
                ...
                array(
                    "type" => "dropdown",
                    "heading" => esc_html__("Layout for Blog", 'rit-core-language'),
                    "param_name" => "layout",
                    'std' => 'grid-view',
                    "value" => array(
                        esc_html__('Grid view', 'rit-core-language' ) => 'grid-view',
                        esc_html__('List view', 'rit-core-language' ) => 'list-view',
                        
                    ),
                    'group'=>esc_html__('Layout','rit-core-language'),
                    'description' => esc_html__('Display layout for blog', 'rit-core-language'),
                ),
                array(
                ...
                array(
                    ...
                    'description' => esc_html__('Yes, If you want to show date post', 'rit-core-language'),
                ),
                array(
                    'type' => 'checkbox',
