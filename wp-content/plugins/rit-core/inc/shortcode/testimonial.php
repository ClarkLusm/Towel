        ...
        vc_map(array(
            ...
            "params" => array(
                ...
                array(
                    ...
                    'description' => esc_html__('Display testimonial with the number of rows', 'rit-core-language'),
                ),
                array(
                    "type" => "dropdown",
                ...
                array(
                    ...
                    'group'=> esc_html__('Style', 'rit-core-language'),
                    "description" => esc_html__("Set image background for block.", 'rit-core-language')
                ),
                array(
                    "type" => "colorpicker",
                    "heading" => esc_html__("Color mask", 'rit-core-language'),
                    "param_name" => "background_color",
                    'group'=> esc_html__('Style', 'rit-core-language'),
                    "description" => esc_html__("Set color mask for block.", 'rit-core-language'),
                    'std'=>'rgba(0,0,0,0.3)'
                ),
                array(
                    "type" => "textfield",
