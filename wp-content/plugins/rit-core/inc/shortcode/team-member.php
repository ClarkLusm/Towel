...
if (!function_exists('rit_member_slider_integrate_vc')) {
    function rit_member_slider_integrate_vc()
    {
        vc_map(
            array(
                'name' => esc_html__('RIT Member Slider', 'rit-core-language'),
                'base' => 'rit_member_slider',
                'icon' => 'icon-rit',
                'category' => esc_html__('RIT', 'rit-core-language'),
                'description' => esc_html__('Show member carousel', 'rit-core-language'),
                'params' => array(
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Number of member', 'rit-core-language'),
                        'value' => '',
                        'param_name' => 'posts_per_page',
                        'description' => esc_html__('Number of member in slide', 'rit-core-language'),
                    ),
                    array(
                        'type' => 'textfield',
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Member size', 'rit-core-language' ),
                        'param_name' => 'size',
                        'value' => 'medium',
